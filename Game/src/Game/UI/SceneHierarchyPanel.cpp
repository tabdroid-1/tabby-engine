...
SceneHierarchyPanel::SceneHierarchyPanel(Tabby::Scene& context)
{
    SetContext(context);
}

void SceneHierarchyPanel::SetContext(Tabby::Scene& context)
{
    m_Context = &context;
    m_SelectionContext = {};
}
...
void SceneHierarchyPanel::OnImGuiRender()
{
    ...
    if (m_Context) {
        m_Context->m_Registry.each([&](auto entityID) {
            Tabby::GameObject entity { entityID, m_Context };
...
void SceneHierarchyPanel::SetSelectedEntity(Tabby::GameObject entity)
{
...
static void DrawComponent(const std::string& name, Tabby::GameObject entity, UIFunction uiFunction)
{
...
void SceneHierarchyPanel::DrawComponents(Tabby::GameObject entity)
{
    ...
    if (ImGui::BeginPopup("AddComponent")) {
        DisplayAddComponentEntry<Tabby::CameraComponent>("Camera");
        DisplayAddComponentEntry<Tabby::NativeScriptComponent>("Script");
    ...
    // if (entity.GetComponent<Tabby::TransformComponent>().parent != entt::null) {
    ...
    DrawComponent<Tabby::NativeScriptComponent>("Script", entity, [entity, scene = m_Context](auto& component) mutable {
    ...
    DrawComponent<Tabby::SpriteRendererComponent>("Sprite Renderer", entity, [](auto& component) {
        // ImGui::ColorEdit4("Color", component.Color);
        //
    ...
    DrawComponent<Tabby::RigidBodyComponent>("Rigidbody 2D", entity, [](auto& component) {
        ...
        if (ImGui::BeginCombo("Body Type", currentBodyTypeString)) {
            for (int i = 0; i < 2; i++) {
                ...
                if (ImGui::Selectable(bodyTypeStrings[i], isSelected)) {
                    ...
                    component.Type = (Tabby::RigidBodyComponent::BodyType)i;
                }
