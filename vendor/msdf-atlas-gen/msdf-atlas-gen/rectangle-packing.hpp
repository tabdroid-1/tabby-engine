...
[[maybe_unused]] static void copyRectanglePlacement(Rectangle& dst, const Rectangle& src)
{
    dst.x = src.x;
    dst.y = src.y;
}

[[maybe_unused]] static void copyRectanglePlacement(OrientedRectangle& dst, const OrientedRectangle& src)
{
    dst.x = src.x;
    dst.y = src.y;
