...
#elif (defined(B2_COMPILER_GCC) || defined(B2_COMPILER_CLANG)) && !defined(B2_PLATFORM_WASM)
	#if defined(B2_CPU_X64) || defined(B2_CPU_X86)
		#define B2_BREAKPOINT __asm volatile("int $0x3")
	#elif defined(B2_CPU_ARM64)
		#define B2_BREAKPOINT __builtin_trap()
	#elif defined(B2_CPU_ARM32)
		#define B2_BREAKPOINT __asm volatile("bkpt #0")
	#endif
