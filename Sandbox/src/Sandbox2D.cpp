...
void Sandbox2D::OnAttach()
{
    ...
    m_Tabby = Tabby::Texture2D::Create("assets/textures/tabbya.png");
...
void Sandbox2D::OnUpdate(Tabby::Timestep ts)
{
...

    {
        ...
        Tabby::Renderer2D::DrawQuad({ 0.0f, 0.0f, -0.1f }, { 20.0f, 20.0f }, m_Tabby, 10.0f);
        Tabby::Renderer2D::DrawRotatedQuad({ -2.0f, 0.0f, 0.0f }, { 1.0f, 1.0f }, rotation, m_CheckerboardTexture, 20.0f);
