    ...
    , m_CameraController(1280.0f / 720.0f)
{
    ...
    squareVB->SetLayout({ { Tabby::ShaderDataType::Float3, "a_Position" },
    ...
    m_Texture = Tabby::Texture2D::Create("assets/textures/Checkerboard.png");
    m_ChernoLogoTexture = Tabby::Texture2D::Create("assets/textures/ChernoLogo.png");
