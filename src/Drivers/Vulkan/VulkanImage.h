...
constexpr VkFormat convert(const ImageFormat& format)
{
    ...
    case ImageFormat::RGB32_HDR:
        return VK_FORMAT_B10G11R11_UFLOAT_PACK32;
    case ImageFormat::RGBA64_HDR:
...
constexpr ImageFormat convert(const VkFormat& format)
{
    ...
    case VK_FORMAT_R8G8_SRGB:
        return ImageFormat::RB16;
    case VK_FORMAT_R8G8B8_SRGB:
        return ImageFormat::RGB24;
    case VK_FORMAT_R8G8B8A8_SRGB:
        return ImageFormat::RGBA32_SRGB;
    case VK_FORMAT_B8G8R8A8_SRGB:
        return ImageFormat::BGRA32_SRGB;
    case VK_FORMAT_B8G8R8A8_UNORM:
        return ImageFormat::BGRA32_UNORM;
    case VK_FORMAT_B10G11R11_UFLOAT_PACK32:
        return ImageFormat::RGB32_HDR;
    ...
    case VK_FORMAT_R8G8B8_UNORM:
        return ImageFormat::RGB24_UNORM;
    default:
        TB_CORE_ASSERT(false);
        return ImageFormat::R8;
    }
...
public:
    ...
    VulkanImage(const ImageSpecification& spec, const std::vector<char> data, const AssetHandle& id);
    ...
    // void SetLayout(Shared<VulkanDeviceCmdBuffer> cmd_buffer, ImageLayout new_layout, PipelineStage src_stage, PipelineStage dst_stage, BitMask src_access = 0, BitMask dst_access = 0) override;
