    ...
    : m_Config(config)
{
    ...
    m_CmdBuffer = CreateShared<VulkanDeviceCmdBuffer>(DeviceCmdBufferLevel::PRIMARY, DeviceCmdBufferType::GENERAL, DeviceCmdType::GENERAL);
}
...
void VulkanRendererAPI::BeginFrame()
{
    ...
    m_CmdBuffer->Begin();
    m_RenderPass->Begin(m_CmdBuffer->Raw());
}

void VulkanRendererAPI::EndFrame()
{
    m_RenderPass->End(m_CmdBuffer->Raw());
...
void VulkanRendererAPI::ExecuteCurrentCommands()
{
    Renderer::Submit(
        [=]() mutable {
            ...
            // Shared<VulkanDeviceCmdBuffer> vk_cmd_buffer = ShareAs<VulkanDeviceCmdBuffer>(m_CmdBuffer);
            VkCommandBuffer raw_buffer = m_CmdBuffer->Raw();
...
//
// void VulkanRendererAPI::ClearImage(Shared<Image> image, const fvec4& value)
// {
//     Renderer::Submit([=]() mutable {
//         image->SetLayout(
//             m_CurrentCmdBuffer,
...
// }
//
// void VulkanRendererAPI::RenderMeshTasks(Shared<Pipeline> pipeline, const glm::uvec3& dimensions, MiscData data)
// {
//     Renderer::Submit([=]() mutable {
...
// }
//
// void VulkanRendererAPI::RenderMeshTasksIndirect(Shared<Pipeline> pipeline, Shared<DeviceBuffer> params, MiscData data)
// {
//     Renderer::Submit([=]() mutable {
//         Shared<VulkanPipeline> vk_pipeline = ShareAs<VulkanPipeline>(pipeline);
...
// }
//
// std::vector<VkDescriptorSet> VulkanRendererAPI::AllocateDescriptorSets(VkDescriptorSetLayout layout, uint32 count)
// {
...
// }
//
// uint32 VulkanRendererAPI::GetDeviceMinimalUniformBufferAlignment() const
// {
//     return m_Device->GetPhysicalDevice()->GetProperties().properties.limits.minUniformBufferOffsetAlignment;
// }
//
// uint32 VulkanRendererAPI::GetDeviceMinimalStorageBufferAlignment() const
// {
//     return m_Device->GetPhysicalDevice()->GetProperties().properties.limits.minStorageBufferOffsetAlignment;
// }
//
// uint32 VulkanRendererAPI::GetDeviceOptimalTaskWorkGroupSize() const
// {
...
// }
//
// uint32 VulkanRendererAPI::GetDeviceOptimalMeshWorkGroupSize() const
// {
//     void* node = m_Device->GetPhysicalDevice()->GetProperties().pNext;
//     VkStructureType type = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MESH_SHADER_PROPERTIES_EXT;
//     while (node != nullptr) {
...
// }
//
// uint32 VulkanRendererAPI::GetDeviceOptimalComputeWorkGroupSize() const
// {
//     return 0;
// }
//
// void VulkanRendererAPI::RenderQuad(Shared<Pipeline> pipeline, MiscData data)
// {
//     Renderer::Submit([=]() mutable {
//         Shared<VulkanPipeline> vk_pipeline = ShareAs<VulkanPipeline>(pipeline);
//
...
// }
//
// void VulkanRendererAPI::RenderQuad(Shared<Pipeline> pipeline, uint32 amount, MiscData data)
// {
//     Renderer::Submit([=]() mutable {
//         Shared<VulkanPipeline> vk_pipeline = ShareAs<VulkanPipeline>(pipeline);
//
...
// }
//
// void VulkanRendererAPI::DispatchCompute(Shared<Pipeline> pipeline, const glm::uvec3& dimensions, MiscData data)
// {
//     Renderer::Submit([=]() mutable {
//         Shared<VulkanPipeline> vk_pipeline = ShareAs<VulkanPipeline>(pipeline);
//
...
// }
//
// void VulkanRendererAPI::RenderUnindexed(Shared<Pipeline> pipeline, Shared<DeviceBuffer> vertex_buffer, MiscData data)
// {
//     Renderer::Submit([=]() mutable {
//         Shared<VulkanPipeline> vk_pipeline = ShareAs<VulkanPipeline>(pipeline);
//
...
{
    // auto image = m_Swapchain->RawFramebuffer();
...
// }
//
// void VulkanRendererAPI::InsertBarrier(const PipelineBarrierInfo& barrier)
// {
//     Renderer::Submit([=]() mutable {
...
// }
//
// void VulkanRendererAPI::BeginRender(const std::vector<Shared<Image>> attachments, uvec3 render_area, ivec2 render_offset, fvec4 clear_color)
// {
//     Renderer::Submit([=]() mutable {
...
// }
//
// void VulkanRendererAPI::BindSet(Shared<DescriptorSet> set, Shared<Pipeline> pipeline, uint8 index)
// {
//     Renderer::Submit([=]() mutable {
