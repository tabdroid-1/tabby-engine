...
public:
    OpenGL33Shader(const std::string& filepath);
    OpenGL33Shader(const std::string& name, const std::string& vertexSrc, const std::string& fragmentSrc);
    virtual ~OpenGL33Shader();
