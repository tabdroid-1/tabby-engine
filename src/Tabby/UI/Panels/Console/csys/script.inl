...
CSYS_INLINE Script::Script(std::string path, bool load_on_init)
...
CSYS_INLINE Script::Script(const char* path, bool load_on_init)
    : m_Path(path)
    , m_FromMemory(false)
{
    // Load file.
...
CSYS_INLINE Script::Script(std::vector<std::string> data)
