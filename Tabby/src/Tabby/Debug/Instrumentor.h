...
#define TB_FUNC_SIG __PRETTY_FUNCTION__
#elif defined(__DMC__) && (__DMC__ >= 0x810)
#define TB_FUNC_SIG __PRETTY_FUNCTION__
#elif (defined(__FUNCSIG__) || (_MSC_VER))
#define TB_FUNC_SIG __FUNCSIG__
#elif (defined(__INTEL_COMPILER) && (__INTEL_COMPILER >= 600)) || (defined(__IBMCPP__) && (__IBMCPP__ >= 500))
#define TB_FUNC_SIG __FUNCTION__
#elif defined(__BORLANDC__) && (__BORLANDC__ >= 0x550)
#define TB_FUNC_SIG __FUNC__
#elif defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901)
#define TB_FUNC_SIG __func__
#elif defined(__cplusplus) && (__cplusplus >= 201103)
#define TB_FUNC_SIG __func__
#else
#define TB_FUNC_SIG "TB_FUNC_SIG unknown!"
#endif
...
#define TB_PROFILE_SCOPE_LINE2(name, line)                                                              \
    constexpr auto fixedName##line = ::Tabby::InstrumentorUtils::CleanupOutputString(name, "__cdecl "); \
...
#else
#define TB_PROFILE_BEGIN_SESSION(name, filepath)
#define TB_PROFILE_END_SESSION()
#define TB_PROFILE_SCOPE(name)
#define TB_PROFILE_FUNCTION()
#endif
