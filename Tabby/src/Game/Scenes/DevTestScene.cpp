...
//     // for (int i = 0; i < 100; i++) {
//     //
//     //     std::string name = "benchmark" + i;
//     //     std::shared_ptr<GameObject> benchMark = std::make_shared<GameObject>(name);
//     //     auto sprite = benchMark->AddComponent<C_Sprite>();
//     //     sprite->Load("assets/random/tabby.png", false);
//     //
//     //     auto benchmarkRigidbody = benchMark->AddComponent<C_Rigidbody>();
//     //     benchmarkRigidbody->Load(physics.GetPhysicsWorld(), b2_dynamicBody, physics.GetPhysicsWorldScale());
//     //     benchmarkRigidbody->CreateBoxFixture({ 1.0f, 1.0f }, 1.0f, 1.0f);
//     //
...
//
//     gameObjects.GetGameObject("player").GetComponent<C_Sprite>()->Load("assets/random/tabby.png", false);
//
